...
impl ::protobuf::Message for INodeSection_QuotaByStorageTypeEntryProto {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<INodeSection_QuotaByStorageTypeEntryProto>(
    ...
    fn default_instance() -> &'static INodeSection_QuotaByStorageTypeEntryProto {
        static mut instance: ::protobuf::lazy::Lazy<INodeSection_QuotaByStorageTypeEntryProto> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const INodeSection_QuotaByStorageTypeEntryProto,
        };
        unsafe {
...
pub struct INodeSection_QuotaByStorageTypeFeatureProto {
    // message fields
    quotas: ::protobuf::RepeatedField<INodeSection_QuotaByStorageTypeEntryProto>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl ::protobuf::Message for INodeSection_QuotaByStorageTypeFeatureProto {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<INodeSection_QuotaByStorageTypeFeatureProto>(
    ...
    fn default_instance() -> &'static INodeSection_QuotaByStorageTypeFeatureProto {
        static mut instance: ::protobuf::lazy::Lazy<INodeSection_QuotaByStorageTypeFeatureProto> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const INodeSection_QuotaByStorageTypeFeatureProto,
        };
        unsafe {
...
pub struct INodeSection_INodeDirectory {
    ...
    acl: ::protobuf::SingularPtrField<INodeSection_AclFeatureProto>,
    xAttrs: ::protobuf::SingularPtrField<INodeSection_XAttrFeatureProto>,
    typeQuotas: ::protobuf::SingularPtrField<INodeSection_QuotaByStorageTypeFeatureProto>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl INodeSection_INodeDirectory {
    ...
    pub fn get_typeQuotas(&self) -> &INodeSection_QuotaByStorageTypeFeatureProto {
        self.typeQuotas.as_ref().unwrap_or_else(|| INodeSection_QuotaByStorageTypeFeatureProto::default_instance())
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x17rollingUpgradeStartTime\x18\x07\x20\x01(\x04\"\x91\r\n\x0cINodeSec\
    ...
    olicyID\x18\n\x20\x01(\r\x1aa\n\x1cQuotaByStorageTypeEntryProto\x122\n\
    \x0bstorageType\x18\x01\x20\x02(\x0e2\x1d.hadoop.hdfs.StorageTypeProto\
    \x12\r\n\x05quota\x18\x02\x20\x02(\x04\x1ap\n\x1eQuotaByStorageTypeFeatu\
    reProto\x12N\n\x06quotas\x18\x01\x20\x03(\x0b2>.hadoop.hdfs.fsimage.INod\
    eSection.QuotaByStorageTypeEntryProto\x1a\xbb\x02\n\x0eINodeDirectory\
    \x12\x18\n\x10modificationTime\x18\x01\x20\x01(\x04\x12\x0f\n\x07nsQuota\
    \x18\x02\x20\x01(\x04\x12\x0f\n\x07dsQuota\x18\x03\x20\x01(\x04\x12\x12\
    \n\npermission\x18\x04\x20\x01(\x06\x12>\n\x03acl\x18\x05\x20\x01(\x0b21\
    .hadoop.hdfs.fsimage.INodeSection.AclFeatureProto\x12C\n\x06xAttrs\x18\
    \x06\x20\x01(\x0b23.hadoop.hdfs.fsimage.INodeSection.XAttrFeatureProto\
    \x12T\n\ntypeQuotas\x18\x07\x20\x01(\x0b2@.hadoop.hdfs.fsimage.INodeSect\
    ion.QuotaByStorageTypeFeatureProto\x1a`\n\x0cINodeSymlink\x12\x12\n\nper\
    mission\x18\x01\x20\x01(\x06\x12\x0e\n\x06target\x18\x02\x20\x01(\x0c\
    \x12\x18\n\x10modificationTime\x18\x03\x20\x01(\x04\x12\x12\n\naccessTim\
    e\x18\x04\x20\x01(\x04\x1a\xcc\x02\n\x05INode\x12:\n\x04type\x18\x01\x20\
    \x02(\x0e2,.hadoop.hdfs.fsimage.INodeSection.INode.Type\x12\n\n\x02id\
    \x18\x02\x20\x02(\x04\x12\x0c\n\x04name\x18\x03\x20\x01(\x0c\x129\n\x04f\
    ile\x18\x04\x20\x01(\x0b2+.hadoop.hdfs.fsimage.INodeSection.INodeFile\
    \x12C\n\tdirectory\x18\x05\x20\x01(\x0b20.hadoop.hdfs.fsimage.INodeSecti\
    on.INodeDirectory\x12?\n\x07symlink\x18\x06\x20\x01(\x0b2..hadoop.hdfs.f\
    simage.INodeSection.INodeSymlink\",\n\x04Type\x12\x08\n\x04FILE\x10\x01\
    \x12\r\n\tDIRECTORY\x10\x02\x12\x0b\n\x07SYMLINK\x10\x03\"`\n\x1dFilesUn\
    derConstructionSection\x1a?\n\x1aFileUnderConstructionEntry\x12\x0f\n\
    \x07inodeId\x18\x01\x20\x01(\x04\x12\x10\n\x08fullPath\x18\x02\x20\x01(\
    \t\"b\n\x15INodeDirectorySection\x1aI\n\x08DirEntry\x12\x0e\n\x06parent\
    \x18\x01\x20\x01(\x04\x12\x14\n\x08children\x18\x02\x20\x03(\x04B\x02\
    \x10\x01\x12\x17\n\x0brefChildren\x18\x03\x20\x03(\rB\x02\x10\x01\"z\n\
    \x15INodeReferenceSection\x1aa\n\x0eINodeReference\x12\x12\n\nreferredId\
    \x18\x01\x20\x01(\x04\x12\x0c\n\x04name\x18\x02\x20\x01(\x0c\x12\x15\n\r\
    dstSnapshotId\x18\x03\x20\x01(\r\x12\x16\n\x0elastSnapshotId\x18\x04\x20\
    \x01(\r\"\xb5\x01\n\x0fSnapshotSection\x12\x17\n\x0fsnapshotCounter\x18\
    \x01\x20\x01(\r\x12\x1c\n\x10snapshottableDir\x18\x02\x20\x03(\x04B\x02\
    \x10\x01\x12\x14\n\x0cnumSnapshots\x18\x03\x20\x01(\r\x1aU\n\x08Snapshot\
    \x12\x12\n\nsnapshotId\x18\x01\x20\x01(\r\x125\n\x04root\x18\x02\x20\x01\
    (\x0b2'.hadoop.hdfs.fsimage.INodeSection.INode\"\x80\x05\n\x13SnapshotDi\
    ffSection\x1a\x20\n\x10CreatedListEntry\x12\x0c\n\x04name\x18\x01\x20\
    \x01(\x0c\x1a\xf7\x01\n\rDirectoryDiff\x12\x12\n\nsnapshotId\x18\x01\x20\
    \x01(\r\x12\x14\n\x0cchildrenSize\x18\x02\x20\x01(\r\x12\x16\n\x0eisSnap\
    shotRoot\x18\x03\x20\x01(\x08\x12\x0c\n\x04name\x18\x04\x20\x01(\x0c\x12\
    F\n\x0csnapshotCopy\x18\x05\x20\x01(\x0b20.hadoop.hdfs.fsimage.INodeSect\
    ion.INodeDirectory\x12\x17\n\x0fcreatedListSize\x18\x06\x20\x01(\r\x12\
    \x18\n\x0cdeletedINode\x18\x07\x20\x03(\x04B\x02\x10\x01\x12\x1b\n\x0fde\
    letedINodeRef\x18\x08\x20\x03(\rB\x02\x10\x01\x1a\xaa\x01\n\x08FileDiff\
    \x12\x12\n\nsnapshotId\x18\x01\x20\x01(\r\x12\x10\n\x08fileSize\x18\x02\
    \x20\x01(\x04\x12\x0c\n\x04name\x18\x03\x20\x01(\x0c\x12A\n\x0csnapshotC\
    opy\x18\x04\x20\x01(\x0b2+.hadoop.hdfs.fsimage.INodeSection.INodeFile\
    \x12'\n\x06blocks\x18\x05\x20\x03(\x0b2\x17.hadoop.hdfs.BlockProto\x1a\
    \x9f\x01\n\tDiffEntry\x12E\n\x04type\x18\x01\x20\x02(\x0e27.hadoop.hdfs.\
    fsimage.SnapshotDiffSection.DiffEntry.Type\x12\x0f\n\x07inodeId\x18\x02\
    \x20\x01(\x04\x12\x11\n\tnumOfDiff\x18\x03\x20\x01(\r\"'\n\x04Type\x12\
    \x0c\n\x08FILEDIFF\x10\x01\x12\x11\n\rDIRECTORYDIFF\x10\x02\"H\n\x12Stri\
    ngTableSection\x12\x10\n\x08numEntry\x18\x01\x20\x01(\r\x1a\x20\n\x05Ent\
    ry\x12\n\n\x02id\x18\x01\x20\x01(\r\x12\x0b\n\x03str\x18\x02\x20\x01(\t\
    \"\xe1\x02\n\x14SecretManagerSection\x12\x11\n\tcurrentId\x18\x01\x20\
    \x01(\r\x12\x1b\n\x13tokenSequenceNumber\x18\x02\x20\x01(\r\x12\x0f\n\
    \x07numKeys\x18\x03\x20\x01(\r\x12\x11\n\tnumTokens\x18\x04\x20\x01(\r\
    \x1a<\n\rDelegationKey\x12\n\n\x02id\x18\x01\x20\x01(\r\x12\x12\n\nexpir\
    yDate\x18\x02\x20\x01(\x04\x12\x0b\n\x03key\x18\x03\x20\x01(\x0c\x1a\xb6\
    \x01\n\x0cPersistToken\x12\x0f\n\x07version\x18\x01\x20\x01(\r\x12\r\n\
    \x05owner\x18\x02\x20\x01(\t\x12\x0f\n\x07renewer\x18\x03\x20\x01(\t\x12\
    \x10\n\x08realUser\x18\x04\x20\x01(\t\x12\x11\n\tissueDate\x18\x05\x20\
    \x01(\x04\x12\x0f\n\x07maxDate\x18\x06\x20\x01(\x04\x12\x16\n\x0esequenc\
    eNumber\x18\x07\x20\x01(\r\x12\x13\n\x0bmasterKeyId\x18\x08\x20\x01(\r\
    \x12\x12\n\nexpiryDate\x18\t\x20\x01(\x04\"W\n\x13CacheManagerSection\
    \x12\x17\n\x0fnextDirectiveId\x18\x01\x20\x02(\x04\x12\x10\n\x08numPools\
    \x18\x02\x20\x02(\r\x12\x15\n\rnumDirectives\x18\x03\x20\x02(\rB6\n&org.\
    apache.hadoop.hdfs.server.namenodeB\x0cFsImageProto\
";
