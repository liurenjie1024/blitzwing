...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ReconfigurationStatusRequestProto\"s\n)GetReconfigurationStatusConfigCha\
    ngeProto\x12\x0c\n\x04name\x18\x01\x20\x02(\t\x12\x10\n\x08oldValue\x18\
    \x02\x20\x02(\t\x12\x10\n\x08newValue\x18\x03\x20\x01(\t\x12\x14\n\x0cer\
    rorMessage\x18\x04\x20\x01(\t\"\x94\x01\n%GetReconfigurationStatusRespon\
    seProto\x12\x11\n\tstartTime\x18\x01\x20\x02(\x03\x12\x0f\n\x07endTime\
    \x18\x02\x20\x01(\x03\x12G\n\x07changes\x18\x03\x20\x03(\x0b26.hadoop.hd\
    fs.GetReconfigurationStatusConfigChangeProto\"*\n(ListReconfigurableProp\
    ertiesRequestProto\"9\n)ListReconfigurablePropertiesResponseProto\x12\
    \x0c\n\x04name\x18\x01\x20\x03(\t2\xab\x03\n\x1eReconfigurationProtocolS\
    ervice\x12\x81\x01\n\x18getReconfigurationStatus\x121.hadoop.hdfs.GetRec\
    onfigurationStatusRequestProto\x1a2.hadoop.hdfs.GetReconfigurationStatus\
    ResponseProto\x12u\n\x14startReconfiguration\x12-.hadoop.hdfs.StartRecon\
    figurationRequestProto\x1a..hadoop.hdfs.StartReconfigurationResponseProt\
    o\x12\x8d\x01\n\x1clistReconfigurableProperties\x125.hadoop.hdfs.ListRec\
    onfigurablePropertiesRequestProto\x1a6.hadoop.hdfs.ListReconfigurablePro\
    pertiesResponseProtoBL\n%org.apache.hadoop.hdfs.protocol.protoB\x1dRecon\
    figurationProtocolProtos\xa0\x01\x01\x88\x01\x01\
";
