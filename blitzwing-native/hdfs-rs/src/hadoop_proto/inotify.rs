...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x16.hadoop.hdfs.EventType\x12\x10\n\x08contents\x18\x02\x20\x02(\x0c\"H\
    \n\x0fEventBatchProto\x12\x0c\n\x04txid\x18\x01\x20\x02(\x03\x12'\n\x06e\
    vents\x18\x02\x20\x03(\x0b2\x17.hadoop.hdfs.EventProto\"\x86\x02\n\x10Cr\
    eateEventProto\x12$\n\x04type\x18\x01\x20\x02(\x0e2\x16.hadoop.hdfs.INod\
    eType\x12\x0c\n\x04path\x18\x02\x20\x02(\t\x12\r\n\x05ctime\x18\x03\x20\
    \x02(\x03\x12\x11\n\townerName\x18\x04\x20\x02(\t\x12\x11\n\tgroupName\
    \x18\x05\x20\x02(\t\x12-\n\x05perms\x18\x06\x20\x02(\x0b2\x1e.hadoop.hdf\
    s.FsPermissionProto\x12\x13\n\x0breplication\x18\x07\x20\x01(\x05\x12\
    \x15\n\rsymlinkTarget\x18\x08\x20\x01(\t\x12\x11\n\toverwrite\x18\t\x20\
    \x01(\x08\x12\x1b\n\x10defaultBlockSize\x18\n\x20\x01(\x03:\x010\"D\n\
    \x0fCloseEventProto\x12\x0c\n\x04path\x18\x01\x20\x02(\t\x12\x10\n\x08fi\
    leSize\x18\x02\x20\x02(\x03\x12\x11\n\ttimestamp\x18\x03\x20\x02(\x03\"9\
    \n\x10AppendEventProto\x12\x0c\n\x04path\x18\x01\x20\x02(\t\x12\x17\n\
    \x08newBlock\x18\x02\x20\x01(\x08:\x05false\"H\n\x10RenameEventProto\x12\
    \x0f\n\x07srcPath\x18\x01\x20\x02(\t\x12\x10\n\x08destPath\x18\x02\x20\
    \x02(\t\x12\x11\n\ttimestamp\x18\x03\x20\x02(\x03\"\xc9\x02\n\x18Metadat\
    aUpdateEventProto\x12\x0c\n\x04path\x18\x01\x20\x02(\t\x12-\n\x04type\
    \x18\x02\x20\x02(\x0e2\x1f.hadoop.hdfs.MetadataUpdateType\x12\r\n\x05mti\
    me\x18\x03\x20\x01(\x03\x12\r\n\x05atime\x18\x04\x20\x01(\x03\x12\x13\n\
    \x0breplication\x18\x05\x20\x01(\x05\x12\x11\n\townerName\x18\x06\x20\
    \x01(\t\x12\x11\n\tgroupName\x18\x07\x20\x01(\t\x12-\n\x05perms\x18\x08\
    \x20\x01(\x0b2\x1e.hadoop.hdfs.FsPermissionProto\x12(\n\x04acls\x18\t\
    \x20\x03(\x0b2\x1a.hadoop.hdfs.AclEntryProto\x12'\n\x06xAttrs\x18\n\x20\
    \x03(\x0b2\x17.hadoop.hdfs.XAttrProto\x12\x15\n\rxAttrsRemoved\x18\x0b\
    \x20\x01(\x08\"3\n\x10UnlinkEventProto\x12\x0c\n\x04path\x18\x01\x20\x02\
    (\t\x12\x11\n\ttimestamp\x18\x02\x20\x02(\x03\"\x9e\x01\n\x0fEventsListP\
    roto\x12'\n\x06events\x18\x01\x20\x03(\x0b2\x17.hadoop.hdfs.EventProto\
    \x12\x11\n\tfirstTxid\x18\x02\x20\x02(\x03\x12\x10\n\x08lastTxid\x18\x03\
    \x20\x02(\x03\x12\x10\n\x08syncTxid\x18\x04\x20\x02(\x03\x12+\n\x05batch\
    \x18\x05\x20\x03(\x0b2\x1c.hadoop.hdfs.EventBatchProto*x\n\tEventType\
