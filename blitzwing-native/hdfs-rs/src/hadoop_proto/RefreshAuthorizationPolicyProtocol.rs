...
//! Generated file from `RefreshAuthorizationPolicyProtocol.proto`
...
impl<'a> ::std::default::Default for &'a RefreshServiceAclRequestProto {
    fn default() -> &'a RefreshServiceAclRequestProto {
        <RefreshServiceAclRequestProto as ::protobuf::Message>::default_instance()
    }
}
...
impl ::protobuf::Message for RefreshServiceAclRequestProto {
    ...
    fn default_instance() -> &'static RefreshServiceAclRequestProto {
...
impl<'a> ::std::default::Default for &'a RefreshServiceAclResponseProto {
    fn default() -> &'a RefreshServiceAclResponseProto {
        <RefreshServiceAclResponseProto as ::protobuf::Message>::default_instance()
    }
}
...
impl ::protobuf::Message for RefreshServiceAclResponseProto {
    ...
    fn default_instance() -> &'static RefreshServiceAclResponseProto {
